    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="card bg-white shadow-xl border border-gray-200 rounded-2xl w-full max-w-md p-6">
        <div className="card-body space-y-5">
          <h2 className="text-2xl font-bold text-gray-800 text-center">Upload Medicine File</h2>
          <input type="file" onChange={handleChange} className="file-input file-input-bordered w-full" />
